...
axios.get('http://localhost:3000/api/projects'); projects.value =  response.data; } catch (error) { console.error(error); } 
}); 
  ...
  <section id="proyek" class="py-20 bg-white">
    <div class="container mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 gap-12">
        ...
        >
          <img :src="imageMap[project.image]" alt="Gambar Proyek" class="w-full h-56 object-cover" />
          <div class="p-6">
            ...
            <a :href="project.link" target="_blank" rel="noopener" class="text-blue-600 font-semibold hover:underline">
              Lihat Detail →
            </a>
          </div>
        </div>
